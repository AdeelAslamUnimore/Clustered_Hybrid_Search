...
class AlgorithmInterface {
 public:
    ...
    virtual std::priority_queue<std::pair<dist_t, labeltype>>
        searchKnn(const void*, size_t, BaseFilterFunctor* isIdAllowed = nullptr, unsigned int start_range=0, unsigned int end_range=0,std::vector<char*> additionalData = std::vector<char*>()) const=0;
